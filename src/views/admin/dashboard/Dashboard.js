...
const Dashboard = () => {
 const navigate = useNavigate();
  ...
  const progressExample = [
    { title: 'New Orders', value: '29.703  ', percent: 40, color: 'success' },
  ...
  return (
    <>
      ...
      {/* ✅ HIDDEN (DO NOT REMOVE): Recent Orders */}
      {/*
      <CRow>
        <CCol xs>
          <CCard className="mb-4">
            <CCardHeader><h3>Recent Orders</h3></CCardHeader>
            <CCardBody> 
              <br /> 
                ...
                <CTableHead className="text-nowrap">
                  <CTableRow>
                    ...
                    <CTableHeaderCell className="bg-body-tertiary">Quantity</CTableHeaderCell>
                     ...
                     <CTableHeaderCell className="bg-body-tertiary">Order type</CTableHeaderCell>
                      <CTableHeaderCell className="bg-body-tertiary">Order Status</CTableHeaderCell>
      ...
      */}
      ...
      {/* ✅ HIDDEN (DO NOT REMOVE): Painter Request */}
      {/*
      <WidgetsBrand className="mb-4" withCharts />
      <CRow>
        <CCol xs>
          <CCard className="mb-4">
            <CCardHeader><h3>Painter Request</h3></CCardHeader>
            <CCardBody> 
              <br /> 
              <CTable align="middle" className="mb-0 border" hover responsive>
                <CTableHead className="text-nowrap">
